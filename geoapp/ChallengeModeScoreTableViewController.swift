//
//  ChallengeModeScoreTableViewController.swift
//  geoapp
//
...
class ChallengeModeScoreTableViewController: UITableViewController{
    ...
    override func viewDidLoad() {
        ...
        challengeTable.accessibilityIdentifier = "challengeTable"
        ...
        Helpers.databaseRef.child("scores").observe(.value, with: { (snapshot) in
            ...
            for (_, value) in score {
                ...
                let currentNormalValue = (value as! NSDictionary)[Helpers.challengeMode] as! Int
            ...
            self.tableView.backgroundColor = UIColor(red: 0.85, green: 0.38, blue: 0.49, alpha: 1.00)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "challengeScoreItemCell", for: indexPath) as? ChallengeModeScoreTableViewCell else {
